...
#define STRING_CONFIG_H_AUTHOR "Lapsha Industries" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Spagoat"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "dd3db502-21e1-4774-91a6-0c7b44145fd2 "
...
#define PIDTEMPBED
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define DEFAULT_bedKp 141.52
    #define DEFAULT_bedKi 27.62
    #define DEFAULT_bedKd 483.40
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 135.52 }
